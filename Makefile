...
# Project 2 (string)
# Make file for string class, tests, test oracle, and salesview
#
# J. Maletic 
# Fall 2025
#
...
msg:
	...
	@echo '  salesview  - Compile salesview and string if necessary.'
...
MYOPS  = test_output test_concat test_subscript test_len_cap test_input test_find_char test_find_string test_substring test_split
...
# Compile Milestone 4
#
salesview.o: salesview.cpp salesentry.hpp string.hpp
	$(CPP) -c $(OPTIONS) salesview.cpp -o salesview.o

salesentry.o: salesentry.cpp salesentry.hpp string.hpp
	$(CPP) -c $(OPTIONS) salesentry.cpp -o salesentry.o

salesview: salesview.o string.o salesentry.o 
	$(CPP) $(OPTIONS) salesview.o string.o salesentry.o -o salesview
